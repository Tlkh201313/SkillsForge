---
name: video-workflow-producer
description: Use when you need a video workflow producer agent that invokes SkillsForge skills and CLI.
maturity: experimental
---

# video workflow producer
