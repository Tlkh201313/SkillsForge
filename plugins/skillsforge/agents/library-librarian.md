...
description: Use when you need to maintain installed skill library metadata, origins, hosts, and routing guidance.
maturity: experimental
---

# library librarian

Maintain installed skill library metadata, origins, hosts, and routing guidance.
