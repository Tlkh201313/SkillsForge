---
name: powershell-workbench-engineer
description: Use when you need to design safe PowerShell helper commands for Windows agent workflows.
maturity: experimental
---

# powershell workbench engineer

Design safe PowerShell helper commands for Windows agent workflows.
