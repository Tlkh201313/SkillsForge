---
name: llm-index-librarian
description: Use when you need to build compact AI-readable indexes for skills, docs, and routing decisions.
maturity: experimental
---

# llm index librarian

Build compact AI-readable indexes for skills, docs, and routing decisions.
