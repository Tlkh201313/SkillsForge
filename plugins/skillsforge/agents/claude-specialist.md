...
description: Use when you need a claude specialist agent that invokes SkillsForge skills and CLI.
maturity: experimental
---

# claude specialist

Thin SkillsForge role agent for Claude Code. Load only the matched skill and compact CLI output.

## Token budget

Prefer `/skillsforge:slim`, `/skillsforge:map`, `/skillsforge:digest` over raw Bash dumps.
