---
name: documentarian
description: Use when you need to record implementation decisions, evidence, and release notes without fake history.
maturity: experimental
---

# documentarian

Record implementation decisions, evidence, and release notes without fake history.
