...
description: Use when you need a codex specialist agent that invokes SkillsForge skills and CLI.
maturity: experimental
---

# codex specialist

Thin SkillsForge role agent for Codex. Load only the matched skill and compact CLI output.

## Token budget

Prefer `sf slim` / `sf map` / `sf digest` over raw shell dumps. Route before loading skill bodies.
