...
description: Use when you need a gemini specialist agent that invokes SkillsForge skills and CLI.
maturity: experimental
---

# gemini specialist

Thin SkillsForge role agent for Gemini CLI hosts. Load only the matched skill and compact CLI output.
