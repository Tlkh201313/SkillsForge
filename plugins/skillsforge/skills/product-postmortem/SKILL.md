...
description: Use when you need product postmortem in a SkillsForge product workflow.
license: MIT
hooks:
  PreToolUse:
...
- Use when you need product postmortem in a SkillsForge product workflow.
