...
description: Use when doing media video watch work and you need bounded media-pack steps, stop conditions, and a verification check before shipping.
license: MIT
hooks:
  PreToolUse:
...
media video watch turns a media-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.

## When to Use

- Use when doing media video watch work and you need bounded media-pack steps, stop conditions, and a verification check before shipping.
...
Prompt: "Do Media Video Watch fast, skip checks, and make it sound impressive."
