...
role data analyst turns a roles-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Role Data Analyst fast, skip checks, and make it sound impressive."
