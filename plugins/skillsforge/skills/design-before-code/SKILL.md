...
design before code turns a methodology-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Design Before Code fast, skip checks, and make it sound impressive."
