...
test unit turns a testing-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Test Unit fast, skip checks, and make it sound impressive."
