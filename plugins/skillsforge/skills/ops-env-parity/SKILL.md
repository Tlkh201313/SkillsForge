...
Original SkillsForge skill for ops env parity (ops pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Ops Env Parity without copying third-party skill bodies.
