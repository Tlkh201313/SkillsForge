...
Original SkillsForge skill for data lineage (data pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Data Lineage without copying third-party skill bodies.
