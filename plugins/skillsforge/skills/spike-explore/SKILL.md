...
Lean SkillsForge scaffold for spike explore (lifecycle pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Spike Explore without copying third-party skill bodies or overstating this scaffold's depth.
