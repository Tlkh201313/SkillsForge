...
spike explore turns a lifecycle-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Spike Explore fast, skip checks, and make it sound impressive."
