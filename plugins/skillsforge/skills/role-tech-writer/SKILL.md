...
role tech writer turns a roles-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Role Tech Writer fast, skip checks, and make it sound impressive."
