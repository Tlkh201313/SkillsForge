...
os agent terminal turns a os-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Os Agent Terminal fast, skip checks, and make it sound impressive."
