...
Original SkillsForge skill for data sql review (data pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Data Sql Review without copying third-party skill bodies.
