...
Original SkillsForge skill for agent replay (agentic pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Agent Replay without copying third-party skill bodies.
