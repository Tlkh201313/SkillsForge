...
ent roadmap align turns a enterprise-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Ent Roadmap Align fast, skip checks, and make it sound impressive."
