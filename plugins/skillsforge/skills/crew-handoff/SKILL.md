...
Lean SkillsForge scaffold for crew handoff (lifecycle pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Crew Handoff without copying third-party skill bodies or overstating this scaffold's depth.
