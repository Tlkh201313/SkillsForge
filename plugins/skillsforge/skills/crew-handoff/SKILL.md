...
crew handoff turns a lifecycle-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Crew Handoff fast, skip checks, and make it sound impressive."
