...
fin runway turns a finance-lite-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Fin Runway fast, skip checks, and make it sound impressive."
