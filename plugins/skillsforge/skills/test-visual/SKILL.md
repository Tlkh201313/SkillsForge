...
Original SkillsForge skill for test visual (testing pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Test Visual without copying third-party skill bodies.
