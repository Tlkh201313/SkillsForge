---
name: design-sidebar
description: Use when doing design sidebar work and you need bounded design-pack steps, stop conditions, and a verification check before shipping.
license: MIT
hooks:
  PreToolUse:
...
design sidebar turns a design-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.

## When to Use

- Use when doing design sidebar work and you need bounded design-pack steps, stop conditions, and a verification check before shipping.
- Need design sidebar with trusted SkillsForge artifacts
...
Prompt: "Do Design Sidebar fast, skip checks, and make it sound impressive."
