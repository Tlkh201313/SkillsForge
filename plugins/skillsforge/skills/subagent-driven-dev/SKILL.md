...
subagent driven dev turns a methodology-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Subagent Driven Dev fast, skip checks, and make it sound impressive."
