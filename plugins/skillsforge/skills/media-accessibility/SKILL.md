...
description: Use when you need media accessibility in a SkillsForge media workflow.
license: MIT
hooks:
  PreToolUse:
...
- Use when you need media accessibility in a SkillsForge media workflow.
