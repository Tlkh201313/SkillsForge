...
design layout turns a design-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Design Layout fast, skip checks, and make it sound impressive."
