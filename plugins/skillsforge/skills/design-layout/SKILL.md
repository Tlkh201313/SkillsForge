...
Original SkillsForge skill for design layout (design pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Design Layout without copying third-party skill bodies.
