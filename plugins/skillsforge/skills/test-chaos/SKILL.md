...
test chaos turns a testing-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Test Chaos fast, skip checks, and make it sound impressive."
