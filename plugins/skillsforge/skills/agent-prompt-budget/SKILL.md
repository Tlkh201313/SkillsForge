...
Original SkillsForge skill for agent prompt budget (agentic pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Agent Prompt Budget without copying third-party skill bodies.
