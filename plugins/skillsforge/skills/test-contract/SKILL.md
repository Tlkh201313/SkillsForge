...
Original SkillsForge skill for test contract (testing pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Test Contract without copying third-party skill bodies.
