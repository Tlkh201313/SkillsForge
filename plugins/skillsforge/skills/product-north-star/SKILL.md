...
description: Use when you need product north star in a SkillsForge product workflow.
license: MIT
hooks:
  PreToolUse:
...
- Use when you need product north star in a SkillsForge product workflow.
