...
Original SkillsForge skill for design color (design pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Design Color without copying third-party skill bodies.
