...
Original SkillsForge skill for sec threat model (security pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Sec Threat Model without copying third-party skill bodies.
