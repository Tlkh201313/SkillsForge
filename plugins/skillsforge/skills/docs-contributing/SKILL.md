...
docs contributing turns a docs-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Docs Contributing fast, skip checks, and make it sound impressive."
