...
Original SkillsForge skill for docs contributing (docs pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Docs Contributing without copying third-party skill bodies.
