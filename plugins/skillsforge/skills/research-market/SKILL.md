...
Lean SkillsForge scaffold for research market (research pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Research Market without copying third-party skill bodies or overstating this scaffold's depth.
