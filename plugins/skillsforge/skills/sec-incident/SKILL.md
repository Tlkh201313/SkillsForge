...
Original SkillsForge skill for sec incident (security pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Sec Incident without copying third-party skill bodies.
