...
Original SkillsForge skill for sec session (security pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Sec Session without copying third-party skill bodies.
