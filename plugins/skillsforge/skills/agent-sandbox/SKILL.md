...
Original SkillsForge skill for agent sandbox (agentic pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Agent Sandbox without copying third-party skill bodies.
