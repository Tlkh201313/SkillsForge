...
Original SkillsForge skill for mobile offline (mobile pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Mobile Offline without copying third-party skill bodies.
