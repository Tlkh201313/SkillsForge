...
Lean SkillsForge scaffold for mobile offline (mobile pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Mobile Offline without copying third-party skill bodies or overstating this scaffold's depth.
