...
mobile offline turns a mobile-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Mobile Offline fast, skip checks, and make it sound impressive."
