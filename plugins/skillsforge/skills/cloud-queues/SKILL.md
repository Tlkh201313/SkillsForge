...
Original SkillsForge skill for cloud queues (cloud-devops pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Cloud Queues without copying third-party skill bodies.
