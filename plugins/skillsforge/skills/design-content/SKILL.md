...
Original SkillsForge skill for design content (design pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Design Content without copying third-party skill bodies.
