...
Original SkillsForge skill for eng rate limits (eng pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Eng Rate Limits without copying third-party skill bodies.
