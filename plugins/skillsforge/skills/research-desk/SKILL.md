...
Lean SkillsForge scaffold for research desk (research pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Research Desk without copying third-party skill bodies or overstating this scaffold's depth.
