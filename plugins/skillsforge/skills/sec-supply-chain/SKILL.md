...
description: Use when you need sec supply chain in a SkillsForge security workflow.
license: MIT
hooks:
  PreToolUse:
...
- Use when you need sec supply chain in a SkillsForge security workflow.
