...
Original SkillsForge skill for agent fanout (agentic pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Agent Fanout without copying third-party skill bodies.
