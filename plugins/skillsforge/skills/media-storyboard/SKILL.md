...
media storyboard turns a media-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Media Storyboard fast, skip checks, and make it sound impressive."
