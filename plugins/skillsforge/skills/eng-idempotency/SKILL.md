      ...
      hooks:
        - type: command
          command: node "${CLAUDE_PLUGIN_ROOT}/hooks/pre-tool-policy.mjs" --policy
            "${CLAUDE_PLUGIN_ROOT}/skills/eng-idempotency/skillsforge.json"
---
...
Lean SkillsForge scaffold for eng idempotency (eng pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Eng Idempotency without copying third-party skill bodies or overstating this scaffold's depth.
