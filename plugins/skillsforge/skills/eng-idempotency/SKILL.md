...
Original SkillsForge skill for eng idempotency (eng pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Eng Idempotency without copying third-party skill bodies.
