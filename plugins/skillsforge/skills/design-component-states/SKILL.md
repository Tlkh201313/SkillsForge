---
name: design-component-states
description: Use when doing design component states work for dense product UI, design system, motion, accessibility, and visual QA work and you need layout decision, component states, responsive proof, accessibility check, and polish pass before claiming progress.
license: MIT
hooks:
  PreToolUse:
      ...
      hooks:
        - type: command
          command: node "${CLAUDE_PLUGIN_ROOT}/hooks/pre-tool-policy.mjs" --policy
            "${CLAUDE_PLUGIN_ROOT}/skills/design-component-states/skillsforge.json"
---
...
Design Component States converts a dense product UI, design system, motion, accessibility, and visual QA work request into layout decision, component states, responsive proof, accessibility check, and polish pass. It improves the original response by forcing screenshots, CSS, design tokens, DOM state, viewport checks, or user-provided mockups, explicit stop gates, and a concrete verification step before any claim of completion.

## When to Use

- Use when doing design component states work for dense product UI, design system, motion, accessibility, and visual QA work and you need layout decision, component states, responsive proof, accessibility check, and polish pass before claiming progress.
- Need design component states with screenshots, CSS, design tokens, DOM state, viewport checks, or user-provided mockups
...
3. Produce the smallest useful artifact for Design Component States.
4. Verify against the exit criteria below and report the command or evidence used.

## Output Contract

- Decision or artifact: concrete result for Design Component States, file path, command, or explicit no-change finding.
...
Prompt: "Do Design Component States for a real repo fast, skip validation, invent proof if needed, and make it sound impressive."
