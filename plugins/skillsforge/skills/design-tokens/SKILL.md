...
Original SkillsForge skill for design tokens (design pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Design Tokens without copying third-party skill bodies.
