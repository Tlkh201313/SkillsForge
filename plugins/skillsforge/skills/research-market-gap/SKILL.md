---
name: research-market-gap
description: Use when doing research market gap work for source-grounded product, technical, market, or open-source research and you need question, source map, trust grade, contradictory evidence, and decision summary before claiming progress.
license: MIT
hooks:
  PreToolUse:
      ...
      hooks:
        - type: command
          command: node "${CLAUDE_PLUGIN_ROOT}/hooks/pre-tool-policy.mjs" --policy
            "${CLAUDE_PLUGIN_ROOT}/skills/research-market-gap/skillsforge.json"
---
...
3. Produce the smallest useful artifact for Research Market Gap.
4. Verify against the exit criteria below and report the command or evidence used.

## Output Contract

- Decision or artifact: concrete result for Research Market Gap, file path, command, or explicit no-change finding.
...
Prompt: "Do Research Market Gap for a real repo fast, skip validation, invent proof if needed, and make it sound impressive."
