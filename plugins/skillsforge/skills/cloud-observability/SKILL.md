...
Original SkillsForge skill for cloud observability (cloud-devops pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Cloud Observability without copying third-party skill bodies.
