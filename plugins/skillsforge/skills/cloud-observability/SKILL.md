...
description: Use when you need cloud observability in a SkillsForge cloud-devops workflow.
license: MIT
hooks:
  PreToolUse:
      ...
      hooks:
        - type: command
          command: node "${CLAUDE_PLUGIN_ROOT}/hooks/pre-tool-policy.mjs" --policy
            "${CLAUDE_PLUGIN_ROOT}/skills/cloud-observability/skillsforge.json"
---
...
Lean SkillsForge scaffold for cloud observability (cloud-devops pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Cloud Observability without copying third-party skill bodies or overstating this scaffold's depth.

## When to Use

- Use when you need cloud observability in a SkillsForge cloud-devops workflow.
