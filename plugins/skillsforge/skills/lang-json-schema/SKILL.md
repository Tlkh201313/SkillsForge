...
Original SkillsForge skill for lang json schema (lang pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Lang Json Schema without copying third-party skill bodies.
