...
ops slos turns a ops-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Ops Slos fast, skip checks, and make it sound impressive."
