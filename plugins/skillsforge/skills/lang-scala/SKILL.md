...
Lean SkillsForge scaffold for lang scala (lang pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Lang Scala without copying third-party skill bodies or overstating this scaffold's depth.
