...
Original SkillsForge skill for lang terraform (lang pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Lang Terraform without copying third-party skill bodies.
