...
Lean SkillsForge scaffold for agent crew (agentic pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Agent Crew without copying third-party skill bodies or overstating this scaffold's depth.
