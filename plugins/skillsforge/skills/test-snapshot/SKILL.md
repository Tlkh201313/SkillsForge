---
name: test-snapshot
description: Use when you need test snapshot in a SkillsForge testing workflow.
license: MIT
hooks:
  PreToolUse:
...
Original SkillsForge skill for test snapshot (testing pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Test Snapshot without copying third-party skill bodies.

## When to Use

- Use when you need test snapshot in a SkillsForge testing workflow.
