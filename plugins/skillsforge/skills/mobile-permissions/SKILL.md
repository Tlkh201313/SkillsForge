...
Original SkillsForge skill for mobile permissions (mobile pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Mobile Permissions without copying third-party skill bodies.
