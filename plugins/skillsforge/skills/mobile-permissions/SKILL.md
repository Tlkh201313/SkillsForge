...
description: Use when you need mobile permissions in a SkillsForge mobile workflow.
license: MIT
hooks:
  PreToolUse:
...
- Use when you need mobile permissions in a SkillsForge mobile workflow.
