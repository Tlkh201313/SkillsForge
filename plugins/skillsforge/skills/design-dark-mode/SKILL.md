...
Original SkillsForge skill for design dark mode (design pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Design Dark Mode without copying third-party skill bodies.
