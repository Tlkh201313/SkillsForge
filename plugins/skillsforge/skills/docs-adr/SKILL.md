...
docs adr turns a docs-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Docs Adr fast, skip checks, and make it sound impressive."
