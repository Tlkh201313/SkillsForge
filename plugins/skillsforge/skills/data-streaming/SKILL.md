...
Original SkillsForge skill for data streaming (data pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Data Streaming without copying third-party skill bodies.
