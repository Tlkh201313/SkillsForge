...
description: Use when doing design saas workbench work and you need bounded design-pack steps, stop conditions, and a verification check before shipping.
license: MIT
hooks:
  PreToolUse:
...
design saas workbench turns a design-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.

## When to Use

- Use when doing design saas workbench work and you need bounded design-pack steps, stop conditions, and a verification check before shipping.
- Need design saas workbench with trusted SkillsForge artifacts
...
Prompt: "Do Design Saas Workbench fast, skip checks, and make it sound impressive."
