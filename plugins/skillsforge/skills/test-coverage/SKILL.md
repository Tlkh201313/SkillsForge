...
Original SkillsForge skill for test coverage (testing pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Test Coverage without copying third-party skill bodies.
