...
sec crypto hygiene turns a security-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Sec Crypto Hygiene fast, skip checks, and make it sound impressive."
