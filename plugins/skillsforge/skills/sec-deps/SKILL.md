---
name: sec-deps
description: Use when you need sec deps in a SkillsForge security workflow.
license: MIT
hooks:
  PreToolUse:
...
Lean SkillsForge scaffold for sec deps (security pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Sec Deps without copying third-party skill bodies or overstating this scaffold's depth.

## When to Use

- Use when you need sec deps in a SkillsForge security workflow.
- Need sec deps with trusted SkillsForge artifacts
