...
Original SkillsForge skill for data pipelines (data pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Data Pipelines without copying third-party skill bodies.
