...
description: Use when you need product roadmap in a SkillsForge product workflow.
license: MIT
hooks:
  PreToolUse:
...
Original SkillsForge skill for product roadmap (product pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Product Roadmap without copying third-party skill bodies.

## When to Use

- Use when you need product roadmap in a SkillsForge product workflow.
