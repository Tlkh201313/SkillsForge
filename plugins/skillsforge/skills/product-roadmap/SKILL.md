...
product roadmap turns a product-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Product Roadmap fast, skip checks, and make it sound impressive."
