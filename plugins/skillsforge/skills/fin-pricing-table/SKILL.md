...
fin pricing table turns a finance-lite-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Fin Pricing Table fast, skip checks, and make it sound impressive."
