...
media style guide turns a media-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Media Style Guide fast, skip checks, and make it sound impressive."
