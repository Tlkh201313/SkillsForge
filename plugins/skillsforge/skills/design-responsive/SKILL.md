...
Lean SkillsForge scaffold for design responsive (design pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Design Responsive without copying third-party skill bodies or overstating this scaffold's depth.
