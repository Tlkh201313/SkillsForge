...
Original SkillsForge skill for agent tool policy (agentic pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Agent Tool Policy without copying third-party skill bodies.
