...
Original SkillsForge skill for ops feature freeze (ops pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Ops Feature Freeze without copying third-party skill bodies.
