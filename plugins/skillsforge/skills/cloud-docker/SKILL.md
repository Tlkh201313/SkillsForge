...
cloud docker turns a cloud-devops-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Cloud Docker fast, skip checks, and make it sound impressive."
