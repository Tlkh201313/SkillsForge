---
name: cloud-docker
description: Use when you need cloud docker in a SkillsForge cloud-devops workflow.
license: MIT
hooks:
  PreToolUse:
...
- Use when you need cloud docker in a SkillsForge cloud-devops workflow.
