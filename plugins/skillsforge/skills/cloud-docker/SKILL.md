...
Original SkillsForge skill for cloud docker (cloud-devops pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Cloud Docker without copying third-party skill bodies.
