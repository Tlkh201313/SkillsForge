...
data backfill turns a data-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Data Backfill fast, skip checks, and make it sound impressive."
