...
legal license pick turns a legal-lite-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Legal License Pick fast, skip checks, and make it sound impressive."
