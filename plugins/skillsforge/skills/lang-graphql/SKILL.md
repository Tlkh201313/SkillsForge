...
Original SkillsForge skill for lang graphql (lang pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Lang Graphql without copying third-party skill bodies.
