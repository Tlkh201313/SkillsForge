...
description: Use when doing design chart ui work and you need bounded design-pack steps, stop conditions, and a verification check before shipping.
license: MIT
hooks:
  PreToolUse:
...
design chart ui turns a design-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.

## When to Use

- Use when doing design chart ui work and you need bounded design-pack steps, stop conditions, and a verification check before shipping.
- Need design chart ui with trusted SkillsForge artifacts
...
Prompt: "Do Design Chart Ui fast, skip checks, and make it sound impressive."
