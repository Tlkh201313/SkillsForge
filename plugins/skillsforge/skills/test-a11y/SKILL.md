...
test a11y turns a testing-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Test A11y fast, skip checks, and make it sound impressive."
