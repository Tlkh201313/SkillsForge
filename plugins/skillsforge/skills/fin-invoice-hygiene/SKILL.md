...
Lean SkillsForge scaffold for fin invoice hygiene (finance-lite pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Fin Invoice Hygiene without copying third-party skill bodies or overstating this scaffold's depth.
