...
Original SkillsForge skill for test regression (testing pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Test Regression without copying third-party skill bodies.
