...
Original SkillsForge skill for docs api ref (docs pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Docs Api Ref without copying third-party skill bodies.
