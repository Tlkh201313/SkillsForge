...
role eng review turns a roles-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Role Eng Review fast, skip checks, and make it sound impressive."
