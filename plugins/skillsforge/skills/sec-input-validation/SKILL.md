...
Original SkillsForge skill for sec input validation (security pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Sec Input Validation without copying third-party skill bodies.
