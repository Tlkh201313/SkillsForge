...
content newsletter turns a content-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Content Newsletter fast, skip checks, and make it sound impressive."
