...
Original SkillsForge skill for test mutation (testing pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Test Mutation without copying third-party skill bodies.
