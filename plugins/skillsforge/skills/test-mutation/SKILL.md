...
test mutation turns a testing-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Test Mutation fast, skip checks, and make it sound impressive."
