...
Original SkillsForge skill for sec secrets (security pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Sec Secrets without copying third-party skill bodies.
