...
fw astro turns a framework-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Fw Astro fast, skip checks, and make it sound impressive."
