...
test load turns a testing-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Test Load fast, skip checks, and make it sound impressive."
