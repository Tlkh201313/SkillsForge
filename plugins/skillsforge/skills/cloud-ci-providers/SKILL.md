...
Original SkillsForge skill for cloud ci providers (cloud-devops pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Cloud Ci Providers without copying third-party skill bodies.
