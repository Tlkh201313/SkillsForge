...
media image brief turns a media-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Media Image Brief fast, skip checks, and make it sound impressive."
