...
Original SkillsForge skill for docs changelog (docs pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Docs Changelog without copying third-party skill bodies.
