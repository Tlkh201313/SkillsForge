...
Lean SkillsForge scaffold for agent critique (agentic pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Agent Critique without copying third-party skill bodies or overstating this scaffold's depth.
