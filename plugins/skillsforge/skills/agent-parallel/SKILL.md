...
Original SkillsForge skill for agent parallel (agentic pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Agent Parallel without copying third-party skill bodies.
