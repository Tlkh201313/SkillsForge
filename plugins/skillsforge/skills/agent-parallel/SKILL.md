...
agent parallel turns a agentic-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Agent Parallel fast, skip checks, and make it sound impressive."
