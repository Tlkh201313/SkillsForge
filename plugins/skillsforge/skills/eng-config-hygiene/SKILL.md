...
Original SkillsForge skill for eng config hygiene (eng pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Eng Config Hygiene without copying third-party skill bodies.
