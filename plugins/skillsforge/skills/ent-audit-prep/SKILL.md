---
name: ent-audit-prep
description: Use when you need ent audit prep in a SkillsForge enterprise workflow.
license: MIT
hooks:
  PreToolUse:
...
- Use when you need ent audit prep in a SkillsForge enterprise workflow.
