...
description: Use when you need eng refactor safe in a SkillsForge eng workflow.
license: MIT
hooks:
  PreToolUse:
...
Lean SkillsForge scaffold for eng refactor safe (eng pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Eng Refactor Safe without copying third-party skill bodies or overstating this scaffold's depth.

## When to Use

- Use when you need eng refactor safe in a SkillsForge eng workflow.
- Need eng refactor safe with trusted SkillsForge artifacts
