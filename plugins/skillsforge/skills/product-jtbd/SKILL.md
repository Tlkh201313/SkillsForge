...
Lean SkillsForge scaffold for product jtbd (product pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Product Jtbd without copying third-party skill bodies or overstating this scaffold's depth.
