...
Lean SkillsForge scaffold for product launch (product pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Product Launch without copying third-party skill bodies or overstating this scaffold's depth.
