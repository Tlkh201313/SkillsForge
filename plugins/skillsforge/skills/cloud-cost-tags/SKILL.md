...
description: Use when you need cloud cost tags in a SkillsForge cloud-devops workflow.
license: MIT
hooks:
  PreToolUse:
...
- Use when you need cloud cost tags in a SkillsForge cloud-devops workflow.
