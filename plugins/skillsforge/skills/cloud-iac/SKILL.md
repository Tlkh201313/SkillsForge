...
Original SkillsForge skill for cloud iac (cloud-devops pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Cloud Iac without copying third-party skill bodies.
