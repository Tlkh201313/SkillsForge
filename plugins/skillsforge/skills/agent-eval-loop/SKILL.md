...
Original SkillsForge skill for agent eval loop (agentic pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Agent Eval Loop without copying third-party skill bodies.
