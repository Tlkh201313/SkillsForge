...
lang ruby turns a lang-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Lang Ruby fast, skip checks, and make it sound impressive."
