...
description: Use when you need fin forecast lite in a SkillsForge finance-lite workflow.
license: MIT
hooks:
  PreToolUse:
...
- Use when you need fin forecast lite in a SkillsForge finance-lite workflow.
