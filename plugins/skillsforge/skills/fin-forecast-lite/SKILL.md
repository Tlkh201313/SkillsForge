...
fin forecast lite turns a finance-lite-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Fin Forecast Lite fast, skip checks, and make it sound impressive."
