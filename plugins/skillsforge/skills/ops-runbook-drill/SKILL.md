...
Original SkillsForge skill for ops runbook drill (ops pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Ops Runbook Drill without copying third-party skill bodies.
