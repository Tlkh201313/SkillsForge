      ...
      hooks:
        - type: command
          command: node "${CLAUDE_PLUGIN_ROOT}/hooks/pre-tool-policy.mjs" --policy
            "${CLAUDE_PLUGIN_ROOT}/skills/ops-runbook-drill/skillsforge.json"
---
...
Lean SkillsForge scaffold for ops runbook drill (ops pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Ops Runbook Drill without copying third-party skill bodies or overstating this scaffold's depth.
