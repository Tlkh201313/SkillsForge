...
Original SkillsForge skill for cloud secrets mgr (cloud-devops pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Cloud Secrets Mgr without copying third-party skill bodies.
