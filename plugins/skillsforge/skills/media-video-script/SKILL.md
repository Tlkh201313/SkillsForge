...
media video script turns a media-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Media Video Script fast, skip checks, and make it sound impressive."
