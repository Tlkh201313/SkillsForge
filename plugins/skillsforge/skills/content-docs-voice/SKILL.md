...
content docs voice turns a content-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Content Docs Voice fast, skip checks, and make it sound impressive."
