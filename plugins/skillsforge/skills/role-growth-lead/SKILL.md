...
role growth lead turns a roles-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Role Growth Lead fast, skip checks, and make it sound impressive."
