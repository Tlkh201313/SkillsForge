...
Lean SkillsForge scaffold for growth copy (growth pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Growth Copy without copying third-party skill bodies or overstating this scaffold's depth.
