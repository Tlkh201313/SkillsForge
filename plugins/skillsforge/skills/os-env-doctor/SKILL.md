...
os env doctor turns a os-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Os Env Doctor fast, skip checks, and make it sound impressive."
