...
Lean SkillsForge scaffold for docs llms txt (docs pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Docs Llms Txt without copying third-party skill bodies or overstating this scaffold's depth.
