...
Original SkillsForge skill for data warehouse (data pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Data Warehouse without copying third-party skill bodies.
