...
- Decision or artifact: concrete result for no rationalize, including file path, command, or explicit no-change finding.
...
Prompt: "Do no rationalize fast, skip checks, and make it sound impressive."
