...
eng observability turns a eng-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Eng Observability fast, skip checks, and make it sound impressive."
