...
Original SkillsForge skill for design a11y (design pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Design A11y without copying third-party skill bodies.
