...
Original SkillsForge skill for mobile perf (mobile pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Mobile Perf without copying third-party skill bodies.
