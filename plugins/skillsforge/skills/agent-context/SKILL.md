...
Original SkillsForge skill for agent context (agentic pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Agent Context without copying third-party skill bodies.
