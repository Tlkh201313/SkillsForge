...
growth landing turns a growth-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Growth Landing fast, skip checks, and make it sound impressive."
