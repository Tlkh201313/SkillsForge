...
description: Use when you need eng concurrency in a SkillsForge eng workflow.
license: MIT
hooks:
  PreToolUse:
...
Original SkillsForge skill for eng concurrency (eng pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Eng Concurrency without copying third-party skill bodies.

## When to Use

- Use when you need eng concurrency in a SkillsForge eng workflow.
