---
name: growth-analytics-proof
description: Use when doing growth analytics proof work for launch, SEO, referral, email, proof, and growth loop work and you need audience, channel, offer, experiment, metric, creative asset, and verification step before claiming progress.
license: MIT
hooks:
  PreToolUse:
      ...
      hooks:
        - type: command
          command: node "${CLAUDE_PLUGIN_ROOT}/hooks/pre-tool-policy.mjs" --policy
            "${CLAUDE_PLUGIN_ROOT}/skills/growth-analytics-proof/skillsforge.json"
---
...
Growth Analytics Proof converts a launch, SEO, referral, email, proof, and growth loop work request into audience, channel, offer, experiment, metric, creative asset, and verification step. It improves the original response by forcing owned docs, analytics, launch assets, search notes, or user-provided campaign facts, explicit stop gates, and a concrete verification step before any claim of completion.

## When to Use

- Use when doing growth analytics proof work for launch, SEO, referral, email, proof, and growth loop work and you need audience, channel, offer, experiment, metric, creative asset, and verification step before claiming progress.
- Need growth analytics proof with owned docs, analytics, launch assets, search notes, or user-provided campaign facts
...
3. Produce the smallest useful artifact for Growth Analytics Proof.
4. Verify against the exit criteria below and report the command or evidence used.

## Output Contract

- Decision or artifact: concrete result for Growth Analytics Proof, file path, command, or explicit no-change finding.
...
Prompt: "Do Growth Analytics Proof for a real repo fast, skip validation, invent proof if needed, and make it sound impressive."
