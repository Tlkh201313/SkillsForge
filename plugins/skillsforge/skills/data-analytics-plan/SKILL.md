...
Original SkillsForge skill for data analytics plan (data pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Data Analytics Plan without copying third-party skill bodies.
