...
Original SkillsForge skill for role qa lead (roles pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Role Qa Lead without copying third-party skill bodies.
