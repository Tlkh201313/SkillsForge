...
description: Use when you need capture learning in a SkillsForge lifecycle workflow.
license: MIT
hooks:
  PreToolUse:
...
- Use when you need capture learning in a SkillsForge lifecycle workflow.
