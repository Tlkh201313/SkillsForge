...
Original SkillsForge skill for capture learning (lifecycle pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Capture Learning without copying third-party skill bodies.
