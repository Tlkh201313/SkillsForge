...
Original SkillsForge skill for agent memory lite (agentic pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Agent Memory Lite without copying third-party skill bodies.
