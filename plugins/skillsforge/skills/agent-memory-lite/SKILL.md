...
agent memory lite turns a agentic-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Agent Memory Lite fast, skip checks, and make it sound impressive."
