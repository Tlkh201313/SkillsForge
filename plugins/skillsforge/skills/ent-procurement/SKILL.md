...
Lean SkillsForge scaffold for ent procurement (enterprise pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Ent Procurement without copying third-party skill bodies or overstating this scaffold's depth.
