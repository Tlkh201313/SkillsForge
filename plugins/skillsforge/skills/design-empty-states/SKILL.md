...
Original SkillsForge skill for design empty states (design pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Design Empty States without copying third-party skill bodies.
