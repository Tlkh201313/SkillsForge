...
Original SkillsForge skill for data contracts (data pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Data Contracts without copying third-party skill bodies.
