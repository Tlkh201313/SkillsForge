...
description: Use when doing design wizard flow work and you need bounded design-pack steps, stop conditions, and a verification check before shipping.
license: MIT
hooks:
  PreToolUse:
...
design wizard flow turns a design-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.

## When to Use

- Use when doing design wizard flow work and you need bounded design-pack steps, stop conditions, and a verification check before shipping.
- Need design wizard flow with trusted SkillsForge artifacts
...
Prompt: "Do Design Wizard Flow fast, skip checks, and make it sound impressive."
