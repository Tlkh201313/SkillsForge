...
Original SkillsForge skill for data governance (data pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Data Governance without copying third-party skill bodies.
