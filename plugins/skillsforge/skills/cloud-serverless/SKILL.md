...
Original SkillsForge skill for cloud serverless (cloud-devops pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Cloud Serverless without copying third-party skill bodies.
