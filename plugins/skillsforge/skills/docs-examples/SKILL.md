...
Original SkillsForge skill for docs examples (docs pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Docs Examples without copying third-party skill bodies.
