...
Original SkillsForge skill for lang markdown (lang pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Lang Markdown without copying third-party skill bodies.
