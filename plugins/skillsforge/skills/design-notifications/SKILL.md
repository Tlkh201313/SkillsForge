...
description: Use when doing design notifications work and you need bounded design-pack steps, stop conditions, and a verification check before shipping.
license: MIT
hooks:
  PreToolUse:
...
design notifications turns a design-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.

## When to Use

- Use when doing design notifications work and you need bounded design-pack steps, stop conditions, and a verification check before shipping.
- Need design notifications with trusted SkillsForge artifacts
...
Prompt: "Do Design Notifications fast, skip checks, and make it sound impressive."
