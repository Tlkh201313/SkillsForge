---
name: content-script
description: Use when you need content script in a SkillsForge content workflow.
license: MIT
hooks:
  PreToolUse:
...
Lean SkillsForge scaffold for content script (content pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Content Script without copying third-party skill bodies or overstating this scaffold's depth.

## When to Use

- Use when you need content script in a SkillsForge content workflow.
