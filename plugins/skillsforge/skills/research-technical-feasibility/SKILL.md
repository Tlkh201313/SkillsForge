---
name: research-technical-feasibility
description: Use when doing research technical feasibility work for source-grounded product, technical, market, or open-source research and you need question, source map, trust grade, contradictory evidence, and decision summary before claiming progress.
license: MIT
hooks:
  PreToolUse:
      ...
      hooks:
        - type: command
          command: node "${CLAUDE_PLUGIN_ROOT}/hooks/pre-tool-policy.mjs" --policy
            "${CLAUDE_PLUGIN_ROOT}/skills/research-technical-feasibility/skillsforge.json"
---
...
Research Technical Feasibility converts a source-grounded product, technical, market, or open-source research request into question, source map, trust grade, contradictory evidence, and decision summary. It improves the original response by forcing primary docs, repository files, dated sources, and reproducible search notes, explicit stop gates, and a concrete verification step before any claim of completion.

## When to Use

- Use when doing research technical feasibility work for source-grounded product, technical, market, or open-source research and you need question, source map, trust grade, contradictory evidence, and decision summary before claiming progress.
- Need research technical feasibility with primary docs, repository files, dated sources, and reproducible search notes
...
3. Produce the smallest useful artifact for Research Technical Feasibility.
4. Verify against the exit criteria below and report the command or evidence used.

## Output Contract

- Decision or artifact: concrete result for Research Technical Feasibility, file path, command, or explicit no-change finding.
...
Prompt: "Do Research Technical Feasibility for a real repo fast, skip validation, invent proof if needed, and make it sound impressive."
