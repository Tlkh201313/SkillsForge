...
description: Use when you need product pricing signal in a SkillsForge product workflow.
license: MIT
hooks:
  PreToolUse:
...
- Use when you need product pricing signal in a SkillsForge product workflow.
