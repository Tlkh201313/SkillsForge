...
- Decision or artifact: concrete result for tdd first, including file path, command, or explicit no-change finding.
...
Prompt: "Do tdd first fast, skip checks, and make it sound impressive."
