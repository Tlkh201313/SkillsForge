...
research synth turns a research-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Research Synth fast, skip checks, and make it sound impressive."
