...
Original SkillsForge skill for triage inbox (lifecycle pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Triage Inbox without copying third-party skill bodies.
