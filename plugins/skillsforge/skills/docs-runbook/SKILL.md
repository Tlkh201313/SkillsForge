...
Original SkillsForge skill for docs runbook (docs pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Docs Runbook without copying third-party skill bodies.
