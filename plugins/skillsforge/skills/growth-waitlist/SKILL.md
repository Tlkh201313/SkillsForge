...
growth waitlist turns a growth-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Growth Waitlist fast, skip checks, and make it sound impressive."
