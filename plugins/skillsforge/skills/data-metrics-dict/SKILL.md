...
data metrics dict turns a data-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Data Metrics Dict fast, skip checks, and make it sound impressive."
