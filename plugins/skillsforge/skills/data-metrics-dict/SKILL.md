...
Original SkillsForge skill for data metrics dict (data pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Data Metrics Dict without copying third-party skill bodies.
