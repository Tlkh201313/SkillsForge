...
Original SkillsForge skill for ops incident comms (ops pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Ops Incident Comms without copying third-party skill bodies.
