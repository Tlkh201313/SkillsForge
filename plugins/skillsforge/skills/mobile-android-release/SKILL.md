...
mobile android release turns a mobile-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Mobile Android Release fast, skip checks, and make it sound impressive."
