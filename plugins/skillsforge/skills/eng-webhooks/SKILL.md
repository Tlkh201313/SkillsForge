...
Original SkillsForge skill for eng webhooks (eng pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Eng Webhooks without copying third-party skill bodies.
