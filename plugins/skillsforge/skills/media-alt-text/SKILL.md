...
media alt text turns a media-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Media Alt Text fast, skip checks, and make it sound impressive."
