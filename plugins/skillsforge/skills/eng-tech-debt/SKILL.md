...
eng tech debt turns a eng-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Eng Tech Debt fast, skip checks, and make it sound impressive."
