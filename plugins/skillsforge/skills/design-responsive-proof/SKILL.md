---
name: design-responsive-proof
description: Use when doing design responsive proof work for dense product UI, design system, motion, accessibility, and visual QA work and you need layout decision, component states, responsive proof, accessibility check, and polish pass before claiming progress.
license: MIT
hooks:
  PreToolUse:
      ...
      hooks:
        - type: command
          command: node "${CLAUDE_PLUGIN_ROOT}/hooks/pre-tool-policy.mjs" --policy
            "${CLAUDE_PLUGIN_ROOT}/skills/design-responsive-proof/skillsforge.json"
---

# Design Responsive Proof
...
- Use when doing design responsive proof work for dense product UI, design system, motion, accessibility, and visual QA work and you need layout decision, component states, responsive proof, accessibility check, and polish pass before claiming progress.
- Need design responsive proof with screenshots, CSS, design tokens, DOM state, viewport checks, or user-provided mockups
...
3. Produce the smallest useful artifact for Design Responsive Proof.
4. Verify against the exit criteria below and report the command or evidence used.

## Output Contract

- Decision or artifact: concrete result for Design Responsive Proof, file path, command, or explicit no-change finding.
...
Prompt: "Do Design Responsive Proof for a real repo fast, skip validation, invent proof if needed, and make it sound impressive."
