...
ops cost turns a ops-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Ops Cost fast, skip checks, and make it sound impressive."
