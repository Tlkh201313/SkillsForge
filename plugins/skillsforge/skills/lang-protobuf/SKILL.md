...
Original SkillsForge skill for lang protobuf (lang pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Lang Protobuf without copying third-party skill bodies.
