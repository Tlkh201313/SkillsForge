...
Original SkillsForge skill for product metrics (product pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Product Metrics without copying third-party skill bodies.
