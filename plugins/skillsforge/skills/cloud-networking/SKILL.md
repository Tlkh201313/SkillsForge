...
Lean SkillsForge scaffold for cloud networking (cloud-devops pack). Add domain examples and verification before calling it production-depth.

## Purpose

Deliver a trustworthy, repeatable outcome for Cloud Networking without copying third-party skill bodies or overstating this scaffold's depth.
