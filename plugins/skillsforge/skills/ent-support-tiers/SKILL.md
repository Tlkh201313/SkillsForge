...
ent support tiers turns a enterprise-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Ent Support Tiers fast, skip checks, and make it sound impressive."
