...
Original SkillsForge skill for docs migration (docs pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Docs Migration without copying third-party skill bodies.
