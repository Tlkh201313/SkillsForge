...
Original SkillsForge skill for docs quickstart (docs pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Docs Quickstart without copying third-party skill bodies.
