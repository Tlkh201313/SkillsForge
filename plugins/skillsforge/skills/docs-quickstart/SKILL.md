...
description: Use when doing docs quickstart work for agent-facing docs, launch media, demo proof, and content production and you need audience, source facts, outline, asset path, claim proof, and publishing check before claiming progress.
license: MIT
hooks:
  PreToolUse:
...
3. Produce the smallest useful artifact for Docs Quickstart.
4. Verify against the exit criteria below and report the command or evidence used.

## Output Contract

- Decision or artifact: concrete result for Docs Quickstart, file path, command, or explicit no-change finding.
...
Prompt: "Do Docs Quickstart for a real repo fast, skip validation, invent proof if needed, and make it sound impressive."
