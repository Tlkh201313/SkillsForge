...
research teardown turns a research-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Research Teardown fast, skip checks, and make it sound impressive."
