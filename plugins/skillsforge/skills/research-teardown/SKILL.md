...
description: Use when you need research teardown in a SkillsForge research workflow.
license: MIT
hooks:
  PreToolUse:
...
- Use when you need research teardown in a SkillsForge research workflow.
