...
Original SkillsForge skill for cloud cdn (cloud-devops pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Cloud Cdn without copying third-party skill bodies.
