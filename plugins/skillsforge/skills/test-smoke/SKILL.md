...
Original SkillsForge skill for test smoke (testing pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Test Smoke without copying third-party skill bodies.
