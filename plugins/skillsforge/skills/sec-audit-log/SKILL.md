...
Original SkillsForge skill for sec audit log (security pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Sec Audit Log without copying third-party skill bodies.
