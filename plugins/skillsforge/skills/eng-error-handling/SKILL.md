...
Original SkillsForge skill for eng error handling (eng pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Eng Error Handling without copying third-party skill bodies.
