...
Original SkillsForge skill for docs troubleshooting (docs pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Docs Troubleshooting without copying third-party skill bodies.
