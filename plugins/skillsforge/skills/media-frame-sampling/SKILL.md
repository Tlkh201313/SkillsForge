...
media frame sampling turns a media-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Media Frame Sampling fast, skip checks, and make it sound impressive."
