...
description: Use when doing os process port doctor work and you need bounded os-pack steps, stop conditions, and a verification check before shipping.
license: MIT
hooks:
  PreToolUse:
...
os process port doctor turns a os-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.

## When to Use

- Use when doing os process port doctor work and you need bounded os-pack steps, stop conditions, and a verification check before shipping.
...
Prompt: "Do Os Process Port Doctor fast, skip checks, and make it sound impressive."
