...
Original SkillsForge skill for eng secrets handling (eng pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Eng Secrets Handling without copying third-party skill bodies.
