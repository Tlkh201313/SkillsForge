...
os shell modernize turns a os-pack request into a bounded, verifiable output with evidence, stop gates, and a concrete next action.
...
Prompt: "Do Os Shell Modernize fast, skip checks, and make it sound impressive."
