...
Original SkillsForge skill for data dashboard (data pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Data Dashboard without copying third-party skill bodies.
