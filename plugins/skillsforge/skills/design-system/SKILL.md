...
Original SkillsForge skill for design system (design pack).

## Purpose

Deliver a trustworthy, repeatable outcome for Design System without copying third-party skill bodies.
