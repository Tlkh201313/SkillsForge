...
function compactInline(value, limit = 200) {
...
export function buildScaffoldFiles(spec) {
  ...
  const description = spec.description
    ?? `Use when doing ${name.replace(/-/g, ' ')} work and you need bounded steps, stop conditions, and a verification check before shipping.`;
...
`;
  ...
  display_name: ${title}
  short_description: ${compactInline(description)}
