...
async function collectReceiptEvidence(root, options) {
  ...
  const packageReady = await pathExists(join(packageRoot, '.claude-plugin', 'plugin.json'));
  const receiptReady = await pathExists(receiptPath);
