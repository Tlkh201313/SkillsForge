...
- [x] `skillsforge evidence` + `skillsforge demo` (unsafe deny → safe package → receipt)
- [x] Path confinement + routing honesty (auto ≤7) + hero depth + thin MCP
...
- [ ] Record public YouTube demo **under 3 minutes** using [hackathon-demo.md](hackathon-demo.md) (prefer Remotion render from [video.md](video.md))
...
cd SkillsForge
git checkout feat/skillsforge-total-dominance   # or main after merge
npm ci
...
- 354 catalog entries / ~25 production-depth heroes — honest depth claim
